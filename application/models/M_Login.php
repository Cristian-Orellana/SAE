...
class M_Login extends CI_Model
{
   ...
   $horarios .= "<li><a href='". base_url('index.php/C_Horarios') ."'>Administrar Horarios</a></li>";
    ...
    $horarios .="<li><a href=' ". base_url('index.php/C_Calendar') ."'>Agendar Citas</a></li>";

    }

    if ($row->id_man == 3) {

    $horarios .="<li><a href='". base_url('index.php/C_Citas') ." '></i>Consultar Citas</a></li>";
    ...
    $usuarios.= "<li><a href='" . base_url('index.php/C_Usuarios') . "'>Resgistrar Usuarios</a></li>";

    }

    if ($row->id_man == 8) {

    $informes.= "<li><a href='" . base_url('index.php/C_Consultar_Horarios') . "'>Consultar Horarios</a></li>";
    ...
    $horarios .="<li><a href=' ". base_url('index.php/C_Calendar_Ad') ."'>Agendar Citas</a></li>";
    ...
    $horarios .="<li><a href='". base_url('index.php/C_Horarios_Ad') ." '>Administrar Horarios</a></li>";
   ...
   $menu_barra="
	 ...
	 <li>
      ...
      $usuarios
        ...
        <li><a href='https://www.codeigniter.com/user_guide/'><i class='fa fa-book'></i> <span>Documentación</span></a></li>
